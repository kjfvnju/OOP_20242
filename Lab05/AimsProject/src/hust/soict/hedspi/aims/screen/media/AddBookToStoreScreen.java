...
public class AddBookToStoreScreen extends AddItemToStoreScreen {
    ...
    protected JPanel buildCenterPanel() {
        ...
        bookForm.add(lblTitle);     bookForm.add(txtTitle);
        bookForm.add(lblCategory);  bookForm.add(txtCategory);
        bookForm.add(lblCost);      bookForm.add(txtCost);
        bookForm.add(new JLabel()); bookForm.add(btnAddBook);
