package hust.soict.hedspi.aims.screen.media;
    ...
    protected JPanel buildCenterPanel() {
        ...
        btnAddCd.addActionListener((ActionEvent evt) -> {
            try {
                ...
                JOptionPane.showMessageDialog(this, "CD successfully added!");
                dispose();
        ...
        formPanel.add(lblCategory);  formPanel.add(txtCategory);
        formPanel.add(lblCost);      formPanel.add(txtCost);
        formPanel.add(lblDirector);  formPanel.add(txtDirector);
        formPanel.add(lblLength);    formPanel.add(txtLength);
        formPanel.add(lblArtist);    formPanel.add(txtArtist);
        formPanel.add(new JLabel()); formPanel.add(btnAddCd);
