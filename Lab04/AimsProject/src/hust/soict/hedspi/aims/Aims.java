...
public class Aims {
    public static void main(String[] args) {
        ...
        Media dvd1 = new DigitalVideoDisc("Interstellar", "Sci-fi", "Christopher Nolan", 169, 25.00f);
        Media dvd2 = new DigitalVideoDisc("Gladiator", "Action", "Ridley Scott", 155, 20.00f);
        Media book = new Book(1, "Design Patterns", "Education", 39.99f);
        Media dvd = new DigitalVideoDisc("Avatar", "Science Fiction", "James Cameron", 162, 22.95f);
        Media anotherDvd = new DigitalVideoDisc("Finding Nemo", "Animation", "Andrew Stanton", 100, 18.50f);
    ...
    public static void sortMediaInCart(Scanner scanner, Cart cart) {
        ...
        System.out.println("1. Tieu de va gia (giam dan)");
