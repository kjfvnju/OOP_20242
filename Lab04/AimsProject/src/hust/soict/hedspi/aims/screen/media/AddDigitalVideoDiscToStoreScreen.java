    ...
    protected JPanel buildCenterPanel() {
        ...
        btnAdd.addActionListener((ActionEvent evt) -> {
            try {
                ...
                JOptionPane.showMessageDialog(this, "DVD successfully added!");
                dispose();
        ...
        inputPanel.add(lblCategory);  inputPanel.add(txtCategory);
        inputPanel.add(lblDirector);  inputPanel.add(txtDirector);
        inputPanel.add(lblLength);    inputPanel.add(txtLength);
        inputPanel.add(lblCost);      inputPanel.add(txtCost);
